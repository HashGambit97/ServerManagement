function Invoke-LogRotation
{
    ...
    .PARAMETER Path
        Specifies a path to one or more locations.  Invoke-LogRotation processes the log files in the specified locations.  Wildcards are accepted.
    ...
    .PARAMETER KeepArchives
        Specifies the number of months to keep compresses log archives.  If you do not specify this parameter, the archives will be retained indefinitely.

    .PARAMETER Include
        Specifies a wildcard selection string of files to include.  The default value is '*.log'.

    .PARAMETER Exclude
        Specifies a wildcard selection string of files to exclude.  By default, no files are excluded
    ...
    begin
    {
        ...
        if ($Exclude)
        {
            $AdditionalParams.Add('Exclude', $Exclude)
        }
